...
-- mysql -hrm-2zef2h27mdnms0009.mysql.rds.aliyuncs.com -urotree -pIDS6955b171bdf7 -Dsvc_tree
drop database if exists svc_tree on cluster 'shard2-repl2';
CREATE DATABASE svc_tree on cluster 'shard2-repl2' ENGINE = MySQL('rm-2zef2h27mdnms0009.mysql.rds.aliyuncs.com:3306', 'svc_tree', 'rotree', 'IDS6955b171bdf7');
